...
//Manipulación de una lista mutable de edades:
//•	Se inicializa con valores predeterminados.
//•	Se muestra el contenido.
//•	Se modifica el primer valor.
//•	Se agrega un valor al final y al inicio.
//•	Se elimina el primer valor.
//•	Se calcula cuántas personas son mayores de edad (edad >= 18).
//•	Se eliminan los elementos que tienen 12 años.